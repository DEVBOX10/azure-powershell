...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Add parameters ''ResourceProviderConnection'' and ''PrivateLink'' to cmdlet ''New-AzHDInsightCluster'' to support relay outbound and private link feature
